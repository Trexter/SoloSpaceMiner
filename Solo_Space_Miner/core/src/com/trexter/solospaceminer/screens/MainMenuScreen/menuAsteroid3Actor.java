 ...
 */
public class menuAsteroid3Actor extends Actor
{
    ...
    public menuAsteroid3Actor(int _startX, int _startY, int _rangeX, int _rangeY, int _delayMillis)
    {
        startX = _startX;
        startY = _startY;
        rangeX = _rangeX;
        ...
        menuAsteroid3Actor.this.setPosition(startX + rand.nextInt(rangeX), startY);
        menuAsteroid3Actor.this.setScale(mapfloat(rand.nextFloat(), 0.0f, 1.0f, 0.25f, 0.5f));
    }
    ...
    private void actionLogic()
    {
        ...
        if(firstRun)
        {
            ...
            if(System.currentTimeMillis() - startTime >= startDelay)
            {
                ...
                //run the action
                menuAsteroid3Actor.this.addAction(pa);
        ...
        else
        {
            ...
            if(menuAsteroid3Actor.this.getActions().size == 0)
            {
