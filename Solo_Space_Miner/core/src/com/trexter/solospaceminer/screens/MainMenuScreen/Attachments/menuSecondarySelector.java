 ...
 */
public class menuSecondarySelector extends Group
{
    ...
    public menuSecondarySelector(float _centerX, float _centerY)
    {
        centerX = _centerX;
        centerY = _centerY;

        //set up all primary parts
        Parts.add(new menuAttachment(centerX, centerY, 0, 2f, "Arvak_Light_Missile.png", "Arvak Light Missile", "test of the description"));
        ...
        this.addListener(new ActorGestureListener()
        {
            ...
            public void fling(InputEvent event, float velocityX, float velocityY, int button) {
                menuSecondarySelector.this.scrollLockLogic(velocityX);
            }

            @Override
            public void pan(InputEvent event, float x, float y, float deltaX, float deltaY) {
                scrollX += deltaX;
                menuSecondarySelector.this.scrollLogic();
            }
        });
    }
